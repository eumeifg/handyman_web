            ...
            ->editColumn('status', function ($servicepackage) {
                return '<div class="custom-control custom-switch custom-switch-text custom-switch-color custom-control-inline">
                    <div class="custom-switch-inner">
                        <input type="checkbox" class="custom-control-input bg-primary change_status" data-type="service_package_status" ' . ($servicepackage->status ? "checked" : "") . ' value="' . $servicepackage->id . '" id="' . $servicepackage->id . '" data-id="' . $servicepackage->id . '">
